...
class HomePage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        homeLeftBtn = tk.Button(self, image=homeLeftImg, bd=0, background="black" ,relief="flat", command=show)
        homeLeftBtn.place(x=0, y=0)

        # 홈 맨 위 가운데 로고
        homeLogoImg = ImageTk.PhotoImage(Image.open('images/homeLogo.png'))
        homeLogoBtn = tk.Button(self, image=homeLogoImg, bd=0, background="black" ,relief="flat", command=show)
        homeLogoBtn.place(x=175, y=0)

        # 홈 맨 위 오른쪽
        homeRightImg = ImageTk.PhotoImage(Image.open('images/homeRight.png'))
        homeRightBtn = tk.Button(self, image=homeRightImg, bd=0, background="black" ,relief="flat", command=show)
        homeRightBtn.place(x=350, y=0)

        # 홈 맨 아래 아이콘들
        home1Img = ImageTk.PhotoImage(Image.open('images/home1.png'))
        home1Btn = tk.Button(self, image=home1Img, bd=0, background="black" ,relief="flat", command=show)
        home1Btn.place(x=5, y=860)

        home2Img = ImageTk.PhotoImage(Image.open('images/home2.png'))
        home2Btn = tk.Button(self, image=home2Img, bd=0, background="black", relief="flat", command=show)
        home2Btn.place(x=95, y=860)

        home3Img = ImageTk.PhotoImage(Image.open('images/home3.png'))
        home3Btn = tk.Button(self, image=home3Img, bd=0, background="black", relief="flat", command=show)
        home3Btn.place(x=185, y=860)

        home4Img = ImageTk.PhotoImage(Image.open('images/home4.png'))
        home4Btn = tk.Button(self, image=home4Img, bd=0, background="black", relief="flat", command=show)
        home4Btn.place(x=275, y=860)

        home5Img = ImageTk.PhotoImage(Image.open('images/home5.png'))
        home5Btn = tk.Button(self, image=home5Img, bd=0, background="black", relief="flat", command=show)
